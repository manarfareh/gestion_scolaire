...
<p   id="demo" > liste vide </p>
 ...
 <button style="margin-left: 400px;background-color: rgb(44, 124, 210);" type="submit" onclick="refresh()"class="btn btn-primary btn-block active" >Actualiser</button>
...
<footer class="container">
    <p style="color:white; margin-top:5px;">&copy; ENICAR 2021-2022</p>
  </footer>
