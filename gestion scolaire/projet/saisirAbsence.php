        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a style="color:rgb(44, 124, 210);" class="nav-link" href="index.html">Home <span class="sr-only">(current)</span></a>
            </li>
...
<div class="form-group">
  <br>
  <label style="color:white"for="semaine">Choisir une semaine:</label><br>
  <input id="semaine" type="week" name="debut" size="10" class="datepicker"/>
</div>
  <div class="form-group">
<label style="color:white" for="classe">Choisir un groupe:</label><br>
<!--
<input list="classe">
...
<div class="form-group">
  <label style="color:white" for="module">Choisir un module:</label><br>
...
<table class="table table-dark" rules="cols" frame="box">
...
<br>
 <!--Bouton Valider-->
 <button style="margin-left: 350px;"  type="submit" class="btn btn-primary btn-block">Valider</button>
 <br>
</form>
</div>  
</main>
